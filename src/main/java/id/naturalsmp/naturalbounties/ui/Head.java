...
import me.naturalsmp.NaturalBounties.features.settings.integrations.external_api.HeadDataBaseClass;
...
public class Head {
    ...
    public static ItemStack createPlayerSkull(String data){
        ...
        if (LoggedPlayers.isLogged(data) && LoggedPlayers.getPlayer(data) != null) {
            ...
            Bukkit.getLogger().warning("[NaturalBounties] Could not create custom head. Use Base64 or install HeadDataBase.");
        }
        return item;
    }

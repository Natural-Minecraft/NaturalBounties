...
import me.naturalsmp.NaturalBounties.*;
import me.naturalsmp.NaturalBounties.bounty_events.BountyEditEvent;
import me.naturalsmp.NaturalBounties.bounty_events.BountyRemoveEvent;
...
import me.naturalsmp.NaturalBounties.features.settings.display.map.HologramRenderer;
import me.naturalsmp.NaturalBounties.features.settings.immunity.ImmunityManager;
import me.naturalsmp.NaturalBounties.features.settings.money.ExcludedItemException;
import me.naturalsmp.NaturalBounties.features.settings.money.NotEnoughCurrencyException;
import me.naturalsmp.NaturalBounties.features.settings.money.NumberFormatting;
import me.naturalsmp.NaturalBounties.ui.gui.GUIOptions;
...
import me.naturalsmp.NaturalBounties.features.challenges.ChallengeType;
import me.naturalsmp.NaturalBounties.features.*;
import me.naturalsmp.NaturalBounties.features.settings.auto_bounties.Prompt;
...
import static me.naturalsmp.NaturalBounties.features.settings.money.NumberFormatting.*;
import static me.naturalsmp.NaturalBounties.ui.gui.GUI.*;
import static me.naturalsmp.NaturalBounties.utils.BountyManager.*;
...
public class Commands implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender sender, Command command, @NotNull String label, String[] args) {
        if (command.getName().equalsIgnoreCase("NaturalBounties")) {
        ...
        } else if (command.getName().equalsIgnoreCase("NaturalBountiesadmin") && sender.hasPermission("NaturalBounties.admin")) {
            if (args.length > 0) {
    ...
    public boolean executeCommand(@NotNull CommandSender sender, String[] args, boolean adminPermission) {
        if (NaturalBounties.isPaused()) {
            if (args.length > 0) {
                ...
                if (!allow) {
                    if (adminPermission || sender.hasPermission(NaturalBounties.getAdminPermission()))
        ...
        if (args.length > 0) {
            if (args[0].equalsIgnoreCase("help") && (adminPermission || sender.hasPermission("NaturalBounties.basic"))) {
                int page;
                if (args.length == 1) {
                    page = 1;
                } else {
            ...
            } else if (args[0].equalsIgnoreCase("sort") && (adminPermission || sender.hasPermission("NaturalBounties.sort"))) {
                ...
                if (adminPermission || sender.hasPermission("NaturalBounties.hunt")) {
                ...
                if ((adminPermission || sender.hasPermission("NaturalBounties.challenges")) && sender instanceof Player) {
                    if (args.length == 1) {
                        // open GUI
                ...
                return false;
            } else if (args[0].equalsIgnoreCase("update-notification") && (adminPermission || sender.hasPermission(NaturalBounties.getAdminPermission()))) {
                if (args.length == 1) {
            ...
            } else if (args[0].equalsIgnoreCase("skin") && (adminPermission || sender.hasPermission(NaturalBounties.getAdminPermission()))) {
                if (args.length > 1) {
            ...
            } else if (args[0].equalsIgnoreCase("cleanEntities") && (adminPermission || sender.hasPermission("NaturalBounties.cleanentities"))) {
                ...
                return true;
            } else if (args[0].equalsIgnoreCase("pause") && (adminPermission || sender.hasPermission(NaturalBounties.getAdminPermission()))) {
                if (NaturalBounties.isPaused()) {
                    sender.sendMessage(LanguageOptions.parse(getPrefix() + ChatColor.RED + "NaturalBounties is already paused.", parser));
                    return false;
                } else {
                    NaturalBounties.setPaused(true);
                    sender.sendMessage(parse(getPrefix() + ChatColor.RED + "NaturalBounties is now paused. Players will only be able to view previous bounties. Run " + ChatColor.GREEN + "/" + ConfigOptions.getPluginBountyCommands().get(0) + " unpause " + ChatColor.RED + " to use all features again.", parser));
                    return true;
                }
            } else if (args[0].equalsIgnoreCase("unpause") && (adminPermission || sender.hasPermission(NaturalBounties.getAdminPermission()))) {
                if (NaturalBounties.isPaused()) {
                    NaturalBounties.setPaused(false);
                    sender.sendMessage(parse(getPrefix() + ChatColor.GREEN + "NaturalBounties is no longer paused.", parser));
                    return true;
                } else {
                    sender.sendMessage(parse(getPrefix() + ChatColor.GREEN + "NaturalBounties is already unpaused.", parser));
                    return false;
                }
            } else if (args[0].equalsIgnoreCase("debug") && (adminPermission || sender.hasPermission(NaturalBounties.getAdminPermission()))) {
                if (args.length == 1) {
                    NaturalBounties.getInstance().sendDebug(sender);
                } else {
                    boolean newValue;
                    newValue = args[1].equalsIgnoreCase("enable");
                    if (newValue != NaturalBounties.isDebug()) {
                        NaturalBounties.setDebug(newValue);
                        if (NaturalBounties.isDebug()) {
                            if (!silent) {
                ...
                return true;
            } else if (args[0].equalsIgnoreCase("board") && (adminPermission || sender.hasPermission(NaturalBounties.getAdminPermission()))) {
                if (!(sender instanceof Player)) {
                    if (!silent)
                        sender.sendMessage("Only players can use this command!");
                    return false;
                ...
                return true;
            } else if (args[0].equalsIgnoreCase("tutorial") && (adminPermission || sender.hasPermission("NaturalBounties.basic.tutorial"))) {
                Tutorial.onCommand(sender, args);
                return true;
            } else if (args[0].equalsIgnoreCase("whitelist") && Whitelist.isEnabled() && (adminPermission || sender.hasPermission("NaturalBounties.whitelist"))) {
                if (sender instanceof Player player) {
                    if (args.length == 1) {
                ...
                return false;
            } else if (args[0].equalsIgnoreCase("currency") && (adminPermission || sender.hasPermission(NaturalBounties.getAdminPermission()))) {
                CurrencySetup.onCommand(sender, args);
                return true;
            } else if (args[0].equalsIgnoreCase("set")) {
                if ((adminPermission || sender.hasPermission("NaturalBounties.set"))) {
                    if (sender instanceof Player) {
                        if (args.length > 1)
            ...
            } else if ((args[0].equalsIgnoreCase("bdc") || args[0].equalsIgnoreCase("broadcast")) && (adminPermission || sender.hasPermission("NaturalBounties.basic"))) {
                if (sender instanceof Player player) {
                ...
                if (!(adminPermission || sender.hasPermission("NaturalBounties.stats"))) {
                    if (!silent)
                        sender.sendMessage(parse(getPrefix() + getMessage("no-permission"), parser));
                    return false;
                }
                ...
                if (args.length > 3 && !(adminPermission || sender.hasPermission(NaturalBounties.getAdminPermission())) || args.length > 5) {
                    // usage
                    if (!silent) {
                        sender.sendMessage(parse(getPrefix() + getMessage("unknown-command"), parser));
                ...
                if ((adminPermission || sender.hasPermission(NaturalBounties.getAdminPermission()))) {
                    try {
                        NaturalBounties.getInstance().loadConfig();
                    } catch (IOException e) {
                        sender.sendMessage(ChatColor.RED + e.toString());
                    }
                    reopenBountiesGUI();
                    if (!silent)
                        sender.sendMessage(parse(getPrefix(), parser) + ChatColor.GREEN + "Reloaded NaturalBounties version " + NaturalBounties.getInstance().getDescription().getVersion());
                } else {
                    if (!silent)
                        sender.sendMessage(parse(getPrefix() + getMessage("unknown-command"), parser));
                    return false;
                ...
                if (args.length > 1 && args[1].equalsIgnoreCase("remove")) {
                    if (args.length == 2 || (args.length == 3 && args[2].equalsIgnoreCase("--confirm"))) {
                        // reg command
                        if (adminPermission || sender.hasPermission("NaturalBounties.removeimmunity") || sender.hasPermission(NaturalBounties.getAdminPermission())) {
                            if (sender instanceof Player player) {
                                    ...
                                    if (ImmunityManager.removeImmunity(player.getUniqueId())) {
                                        ...
                                        if (!silent) {
                                            ...
                                            if (playerData.hasGeneralImmunity())
                                                builder.append("NaturalBounties.immune ");
                                            if (playerData.hasMurderImmunity())
                                                builder.append("NaturalBounties.immunity.murder ");
                                            if (playerData.hasTimedImmunity())
                                                builder.append("NaturalBounties.immunity.timed ");
                                            if (playerData.hasRandomImmunity())
                                                builder.append("NaturalBounties.immunity.random ");
                                            if (builder.isEmpty()) {
                                                ...
                                                if (sender.hasPermission(NaturalBounties.getAdminPermission())) {
                                                    sender.sendMessage(parse(getPrefix() + ChatColor.RED + "If you think this is is a mistake, see this FAQ entry: " + ChatColor.GRAY + "https://github.com/No-Not-Jaden/NaturalBounties/wiki/FAQ#how-do-i-make-operatorsadmins-not-immune-to-bounties", parser));
                                                }
                                            }
                                        }
                                        return false;
                        ...
                        if (adminPermission || sender.hasPermission(NaturalBounties.getAdminPermission())) {
                            ...
                            } else if (sender.hasPermission("NaturalBounties.buyimmunity") && ImmunityManager.getImmunityType() != ImmunityManager.ImmunityType.DISABLE) {
                                if (!silent)
                                    sender.sendMessage(parse(getPrefix() + getMessage("unknown-command"), parser));
                                switch (ImmunityManager.getImmunityType()) {
                                    case PERMANENT:
                        ...
                        } else if (sender.hasPermission("NaturalBounties.removeimmunity")) {
                            if (!silent) {
                                sender.sendMessage(parse(getPrefix() + getMessage("unknown-command"), parser));
                                sendHelpMessage(sender, getListMessage("help.remove-immunity"));
                            }
                    ...
                    if (sender instanceof Player) {
                        if (ImmunityManager.getImmunityType() != ImmunityManager.ImmunityType.DISABLE) {
                            if (adminPermission || sender.hasPermission("NaturalBounties.buyimmunity")) {
                                if (ImmunityManager.getImmunityType() == ImmunityManager.ImmunityType.PERMANENT) {
                                    ...
                                    if (immunitySpent < ImmunityManager.getPermanentCost() && !(sender.hasPermission("NaturalBounties.immune") && ImmunityManager.isPermissionImmunity())) {
                ...
                if (sender instanceof Player) {
                    if (ConfigOptions.getMoney().isBuyOwn()) {
                        if (adminPermission || sender.hasPermission("NaturalBounties.buyown")) {
                ...
                if (adminPermission || sender.hasPermission("NaturalBounties.view")) {
                    if (args.length > 1) {
                        ...
                        assert bounty != null;
                        double bountyAmount = Whitelist.isShowWhitelistedBounties() || sender.hasPermission(NaturalBounties.getAdminPermission()) || !(sender instanceof Player) ? bounty.getTotalDisplayBounty() : bounty.getTotalDisplayBounty(parser);
                        if (bountyAmount == 0) {
                            if (!silent)
                                sender.sendMessage(parse(getPrefix() + getMessage("no-bounty"), args[1], parser));
                            return false;
                        ...
                        if (args.length > 2) {
                            if (args[2].equalsIgnoreCase("list")) {
                                ...
                                for (Setter setters : bounty.getSetters()) {
                                    if (Whitelist.isShowWhitelistedBounties() || sender.hasPermission(NaturalBounties.getAdminPermission()) || !(sender instanceof Player) || setters.canClaim(parser)) {
                ...
                } else if (adminPermission || sender.hasPermission("NaturalBounties.removeset") && sender instanceof Player) {
                    if (args.length != 2) {
                        // usage
                        if (!silent) {
                            sender.sendMessage(parse(getPrefix() + getMessage("unknown-command"), parser));
                ...
                if (!(BountyMap.isGiveOwn() || sender.hasPermission(NaturalBounties.getAdminPermission()) || sender.hasPermission("NaturalBounties.spawnposter") || sender.hasPermission("NaturalBounties.writeposter") || BountyMap.isWritePoster())) {
                    // no permission
                    if (!silent)
                        sender.sendMessage(parse(getPrefix() + getMessage("no-permission"), parser));
                    return false;
                }
                if (!sender.hasPermission(NaturalBounties.getAdminPermission()) && sender instanceof Player) {
                ...
                if (args.length > 2) {
                    if (args[2].equalsIgnoreCase("hologram") && parser != null) {
                        BountyMap.registerHologram(new HologramRenderer(playerUUID, NaturalBounties.getInstance(), parser.getLocation(), parser.getEyeLocation().getDirection()));
                    ...
                    } else if (!(BountyMap.isGiveOwn() || sender.hasPermission(NaturalBounties.getAdminPermission()) || sender.hasPermission("NaturalBounties.spawnposter"))) {
                ...
                if (BountyTracker.isEnabled())
                    ...
                    if (sender.hasPermission(NaturalBounties.getAdminPermission()) || sender.hasPermission("NaturalBounties.spawntracker") || sender.hasPermission("NaturalBounties.writeemptytracker") || ((BountyTracker.isGiveOwnTracker() || BountyTracker.isWriteEmptyTrackers()) && (adminPermission || sender.hasPermission("NaturalBounties.tracker")))) {
                        if (!(adminPermission || sender.hasPermission(NaturalBounties.getAdminPermission())) && sender instanceof Player player) {
                        ...
                        if (args.length > 1) {
                            ...
                            if (giveEmpty || hasBounty(playerUUID)) {
                                ...
                                if (args.length > 2) {
                                    ...
                                    if (sender instanceof Player) {
                                        if (!(adminPermission || sender.hasPermission("NaturalBounties.tracker")) && !sender.hasPermission(NaturalBounties.getAdminPermission())) {
                                            // no permission
                                            if (!silent)
                                                sender.sendMessage(parse(getPrefix() + getMessage("no-permission"), parser));
                                            return false;
                                        ...
                                        if ((BountyTracker.isWriteEmptyTrackers() || sender.hasPermission("NaturalBounties.writeemptytracker")) && trackedPlayers != null && trackedPlayers.equals(DataManager.GLOBAL_SERVER_ID)) {
                                        ...
                                        } else if (BountyTracker.isGiveOwnTracker() || sender.hasPermission("NaturalBounties.spawntracker") || sender.hasPermission(NaturalBounties.getAdminPermission())) {
                                            // does not have an empty tracker
                                            NumberFormatting.givePlayer(parser, tracker, 1); // give new tracker
                                        } else {
                                            if (BountyTracker.isWriteEmptyTrackers() || sender.hasPermission("NaturalBounties.writeemptytracker")) {
                                                // Does not have an empty tracker
                                                if (!silent)
                ...
                if (adminPermission || sender.hasPermission("NaturalBounties.set")) {
                    ...
                    if (playerUUID == null || (!ConfigOptions.isOfflineSet() && !NaturalBounties.getNetworkPlayers().containsKey(playerUUID))) {
                        // can't find player
                        if (args.length == 1) {
                            if (!silent) {
                                sender.sendMessage(parse(getPrefix() + getMessage("unknown-command"), parser));
                    ...
                    Whitelist whitelist = (sender instanceof Player player) && (adminPermission || sender.hasPermission("NaturalBounties.whitelist")) && Whitelist.isEnabled() ? DataManager.getPlayerData(player.getUniqueId()).getWhitelist() : new Whitelist(new TreeSet<>(), false);
                    if (args.length > 3 && (adminPermission || sender.hasPermission("NaturalBounties.whitelist"))) {
                        ...
                        if (checkBalance(parser, total)) {
                            ...
                            NaturalBounties.getServerImplementation().async().runNow(() -> {
                                ...
                                if (!player.isOnline() && ConfigOptions.isRemoveBannedPlayers() && BanChecker.isPlayerBanned(player)) {
                                    NaturalBounties.getServerImplementation().global().run(() -> {
    ...
    public List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String alias, String[] args) {
        ...
        if (command.getName().equalsIgnoreCase("NaturalBounties") || command.getName().equalsIgnoreCase("NaturalBountiesadmin")) {
            boolean silent = false;
            for (int i = 0; i < args.length; i++) {
                // check if the argument has the -s
                if (args[i].equalsIgnoreCase("-s")) {
            ...
            if (command.getName().equalsIgnoreCase("NaturalBountiesadmin")) {
                if (sender.hasPermission("NaturalBounties.admin")) {
                    if (args.length == 1) {
            ...
            if (args.length == 1) {
                if (sender.hasPermission("NaturalBounties.basic")) {
                    tab.add("help");
                    tab.add("bdc");
                    tab.add("broadcast");
                }
                if (BountyHunt.isEnabled() && (sender.hasPermission("NaturalBounties.hunt.start") || sender.hasPermission("NaturalBounties.hunt.participate")))
                    tab.add("hunt");
                if (sender.hasPermission("NaturalBounties.basic.tutorial")) {
                    tab.add("tutorial");
                }
                if (sender.hasPermission("NaturalBounties.set")) {
                    for (Map.Entry<UUID, String> entry : NaturalBounties.getNetworkPlayers().entrySet()) {
                ...
                if (sender.hasPermission("NaturalBounties.cleanentities")) {
                ...
                } else if (sender.hasPermission("NaturalBounties.removeset")) {
                    tab.add("remove");
                }
                if (BountyMap.isEnabled() && (sender.hasPermission(NaturalBounties.getAdminPermission()) || BountyMap.isGiveOwn()|| sender.hasPermission("NaturalBounties.spawnposter") || BountyMap.isWritePoster() || sender.hasPermission("NaturalBounties.writeposter")))
                    tab.add("poster");
                if ((sender.hasPermission(NaturalBounties.getAdminPermission()) || sender.hasPermission("NaturalBounties.spawntracker") || sender.hasPermission("NaturalBounties.writeemptytracker") || ((BountyTracker.isGiveOwnTracker() || BountyTracker.isWriteEmptyTrackers()) && sender.hasPermission("NaturalBounties.tracker"))) && BountyTracker.isEnabled())
                    tab.add("tracker");
                if (sender.hasPermission("NaturalBounties.buyown") && ConfigOptions.getMoney().isBuyOwn()) {
                    tab.add("buy");
                }
                if (ImmunityManager.getImmunityType() != ImmunityManager.ImmunityType.DISABLE || sender.hasPermission(NaturalBounties.getAdminPermission())) {
                    if (sender.hasPermission("NaturalBounties.buyimmunity")) {
                        tab.add("immunity");
                    }
                }
                ...
                if (args[0].equalsIgnoreCase("check") && sender.hasPermission("NaturalBounties.view")) {
                    ...
                    if (sender.hasPermission("NaturalBounties.hunt.start")) {
                        List<Bounty> bountyList = BountyManager.getPublicBounties(-1);
                        if (bountyList.size() <= ConfigOptions.getMaxTabCompletePlayers()) {
                            for (Bounty bounty : bountyList) {
                                tab.add(bounty.getName());
                    ...
                    if (sender.hasPermission("NaturalBounties.hunt.participate") && sender instanceof Player player) {
                        tab.add("list");
                ...
                } else if ((args[0].equalsIgnoreCase("remove") || args[0].equalsIgnoreCase("edit") && sender.hasPermission(NaturalBounties.getAdminPermission()))) {
                    List<Bounty> bountyList = BountyManager.getAllBounties(-1);
                    if (bountyList.size() <= ConfigOptions.getMaxTabCompletePlayers()) {
                        for (Bounty bounty : bountyList) {
                            tab.add(bounty.getName());
                    ...
                    if ((sender.hasPermission(NaturalBounties.getAdminPermission()) || sender.hasPermission("NaturalBounties.removeimmunity")))
                        tab.add("remove");
                    if ((sender.hasPermission(NaturalBounties.getAdminPermission()) || sender.hasPermission("NaturalBounties.buyimmunity")) && ImmunityManager.getImmunityType() == ImmunityManager.ImmunityType.PERMANENT)
                        tab.add("--confirm");
                } else if ((args[0].equalsIgnoreCase("top") || args[0].equalsIgnoreCase("stat")) && sender.hasPermission("NaturalBounties.stats")) {
                    tab.add("all");
                    tab.add("kills");
                    tab.add("claimed");
                    tab.add("deaths");
                    ...
                    tab.add("immunity");
                    tab.add("current");
                } else if (args[0].equalsIgnoreCase("tracker") && BountyTracker.isEnabled() && (sender.hasPermission(NaturalBounties.getAdminPermission()) || sender.hasPermission("NaturalBounties.spawntracker") || sender.hasPermission("NaturalBounties.writeemptytracker") ||
                        ((BountyTracker.isGiveOwnTracker() || (BountyTracker.isWriteEmptyTrackers() && sender instanceof Player player && DataManager.GLOBAL_SERVER_ID.equals(BountyTracker.getTrackedPlayer(player.getInventory().getItemInMainHand())))) && sender.hasPermission("NaturalBounties.tracker")))) {

                    List<Bounty> bountyList = sender.hasPermission(NaturalBounties.getAdminPermission()) ? BountyManager.getAllBounties(-1) : BountyManager.getPublicBounties(-1);
                    if (bountyList.size() <= ConfigOptions.getMaxTabCompletePlayers()) {
                        for (Bounty bounty : bountyList) {
                            tab.add(bounty.getName());
                        }
                    ...
                    if (sender.hasPermission(NaturalBounties.getAdminPermission()))
                        tab.add("empty");
                } else if (args[0].equalsIgnoreCase("set") && sender.hasPermission("NaturalBounties.set")) {
                    tab.add("offline");
                } else if (args[0].equalsIgnoreCase("whitelist") && sender.hasPermission("NaturalBounties.whitelist") && Whitelist.isEnabled()) {
                    tab.add("add");
                    tab.add("remove");
                    tab.add("set");
                    tab.add("offline");
                    ...
                    tab.add("view");
                    tab.add("toggle");
                } else if (args[0].equalsIgnoreCase("poster") && (sender.hasPermission(NaturalBounties.getAdminPermission()) || BountyMap.isGiveOwn() || sender.hasPermission("NaturalBounties.spawnposter"))) {
                    List<Bounty> bountyList = sender.hasPermission(NaturalBounties.getAdminPermission()) ? BountyManager.getAllBounties(-1) : BountyManager.getPublicBounties(-1);
                    if (bountyList.size() <= ConfigOptions.getMaxTabCompletePlayers()) {
                        for (Bounty bounty : bountyList) {
                            tab.add(bounty.getName());
                ...
                } else if (args[0].equalsIgnoreCase("board") && sender.hasPermission(NaturalBounties.getAdminPermission())) {
                    tab.add("clear");
                    tab.add("remove");
                } else if (args[0].equalsIgnoreCase("debug") && sender.hasPermission(NaturalBounties.getAdminPermission())) {
                    if (NaturalBounties.isDebug())
                        tab.add("disable");
                    else
                        tab.add("enable");
                } else if (args[0].equalsIgnoreCase("bdc") && sender.hasPermission("NaturalBounties.basic")) {
                    tab.add("disable");
                    tab.add("extended");
                    tab.add("short");
                } else if (args[0].equalsIgnoreCase("challenges") && sender.hasPermission("NaturalBounties.challenges") && ChallengeManager.isEnabled()) {
                    tab.add("claim");
                    tab.add("check");
                ...
                if ((args[0].equalsIgnoreCase("remove") || args[0].equalsIgnoreCase("edit")) && sender.hasPermission(NaturalBounties.getAdminPermission())) {
                    tab.add("from");
                } else if (args[0].equalsIgnoreCase("hunt") && BountyHunt.isEnabled()) {
                    if (sender.hasPermission("NaturalBounties.hunt.participate") && sender instanceof Player player) {
                    ...
                    if (args[1].equalsIgnoreCase("remove") && sender.hasPermission(NaturalBounties.getAdminPermission())) {
                        for (Map.Entry<UUID, String> entry : NaturalBounties.getNetworkPlayers().entrySet()) {
                            if (entry.getValue().length() < 25)
                                tab.add(entry.getValue());
                        }
                    }
                    if ((sender.hasPermission(NaturalBounties.getAdminPermission()) || sender.hasPermission("NaturalBounties.buyimmunity")) && (ImmunityManager.getImmunityType() == ImmunityManager.ImmunityType.SCALING || ImmunityManager.getImmunityType() == ImmunityManager.ImmunityType.TIME))
                        tab.add("--confirm");
                ...
                } else if (args[0].equalsIgnoreCase("top") && sender.hasPermission("NaturalBounties.view")) {
                    tab.add("list");
                } else if (args[0].equalsIgnoreCase("check") && sender.hasPermission("NaturalBounties.view")) {
                    tab.add("list");
                } else if (args[0].equalsIgnoreCase("stat") && sender.hasPermission("NaturalBounties.stats")) {
                    for (Map.Entry<UUID, String> entry : NaturalBounties.getNetworkPlayers().entrySet()) {
                        if (entry.getValue().length() < 25)
                            tab.add(entry.getValue());
                    }
                } else if (args[0].equalsIgnoreCase("whitelist") && sender.hasPermission("NaturalBounties.whitelist") && Whitelist.isEnabled() && Whitelist.isAllowTogglingWhitelist() && args[1].equalsIgnoreCase("toggle")) {
                    tab.add("blacklist");
                    tab.add("whitelist");
                } else if (args[0].equalsIgnoreCase("challenges") && ChallengeManager.isEnabled()) {
                    for (int i = 0; i < ChallengeManager.getConcurrentChallenges(); i++) {
                ...
                } else if (args[0].equalsIgnoreCase("stat") && sender.hasPermission(NaturalBounties.getAdminPermission())) {
                    tab.add("edit");
                    tab.add("setValue");
                }
            }
            if (args.length > 2) {
                ...
                if ((sender.hasPermission("NaturalBounties.set") && isPlayer) || (args[0].equalsIgnoreCase("whitelist") && !args[1].equalsIgnoreCase("remove") && sender.hasPermission("NaturalBounties.whitelist")))
                    for (Map.Entry<UUID, String> entry : NaturalBounties.getNetworkPlayers().entrySet()) {
                        if (entry.getValue().length() < 25)
                            tab.add(entry.getValue());
                    }
                if (sender.hasPermission("NaturalBounties.set") && isPlayer && ConfigOptions.isBountyConfirmation())
                    tab.add("--confirm");
                if (args[0].equalsIgnoreCase("whitelist") && args[1].equalsIgnoreCase("remove") && sender.hasPermission("NaturalBounties.whitelist") && sender instanceof Player player) {
            ...
            if (tab.isEmpty() && LoggedPlayers.getLoggedPlayers().size() <= ConfigOptions.getMaxTabCompletePlayers()) {
                if (args.length == 1 || args.length > 2) {
                    if (sender.hasPermission("NaturalBounties.set") && ConfigOptions.isOfflineSet()) {
                ...
                if (args.length == 3) {
                    if ((args[0].equalsIgnoreCase("immunity") && args[1].equalsIgnoreCase("remove") && sender.hasPermission(NaturalBounties.getAdminPermission())) || (args[0].equalsIgnoreCase("stat") && sender.hasPermission("NaturalBounties.stats"))) {
                        tab.addAll(LoggedPlayers.getLoggedPlayers().values());
                    }
                }
                if (args.length > 2) {
                    if (args[0].equalsIgnoreCase("whitelist") && sender.hasPermission("NaturalBounties.whitelist")) {
                        tab.addAll(LoggedPlayers.getLoggedPlayers().values());
                    }
                }
                tab.removeIf(test -> test.toLowerCase(Locale.ROOT).indexOf(typed.toLowerCase(Locale.ROOT)) != 0);

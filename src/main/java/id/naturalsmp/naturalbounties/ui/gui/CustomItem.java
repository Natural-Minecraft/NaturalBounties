...
import static me.naturalsmp.NaturalBounties.features.LanguageOptions.parse;
...
public class CustomItem {
    ...
    private String parseReplacements(String str, OfflinePlayer player, String[] replacements) {
        return parse(str.replace("{leaderboard}", replacements[0])
                ...
                .replace("%NaturalBounties_current_page%", replacements[4])
                .replace("%NaturalBounties_total_pages%", replacements[5]);
    }
    ...
    public ItemStack getFormattedItem(OfflinePlayer player, String[] replacements){
        ...
        if (NaturalBounties.isAboveVersion(21, 3) && itemModel != null)
        ...
        if (hideTooltip && NaturalBounties.isAboveVersion(20, 4)) {
    ...
    public static NamespacedKey getItemModel(@Nullable String model) {
        ...
        if (model.contains(":")) {
            ...
            return new NamespacedKey(NaturalBounties.getInstance(), model);
        }
    }

...
public class GUIComponent {
    ...
    public GUIComponent(ConfigurationSection configuration) {
        ...
        try {
            ...
            Bukkit.getLogger().warning("[NaturalBounties] Invalid or no type for component \"" + name + "\" in bedrock-gui.yml");
        }
            ...
            case SLIDER:
                ...
                if (options.containsKey("min")) {
                    try {
                        ...
                        Bukkit.getLogger().warning("[NaturalBounties] Could not parse a min value for slider component \"" + name + "\" in bedrock-gui.yml");
                    }
                }
                if (options.containsKey("max")) {
                    try {
                        ...
                        Bukkit.getLogger().warning("[NaturalBounties] Could not parse a max value for slider component \"" + name + "\" in bedrock-gui.yml");
                    }
                }
                if (options.containsKey("step")) {
                    try {
                        ...
                        Bukkit.getLogger().warning("[NaturalBounties] Could not parse a step value for slider component \"" + name + "\" in bedrock-gui.yml");
                    }
                }
                if (options.containsKey("default")) {
                    try {
                        ...
                        Bukkit.getLogger().warning("[NaturalBounties] Could not parse a default value for slider component \"" + name + "\" in bedrock-gui.yml");
                        defaultValue = min;
                    }
                } else {
                    defaultValue = min;
            ...
            case STEP_SLIDER:
                ...
                if (options.containsKey("default-step")) {
                    try {
                        ...
                        Bukkit.getLogger().warning("[NaturalBounties] Could not parse a default slider value for step slider component \"" + name + "\" in bedrock-gui.yml");
                    }
                }

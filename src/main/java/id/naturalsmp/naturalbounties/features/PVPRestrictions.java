...
import me.naturalsmp.NaturalBounties.PVPHistory;
...
import static me.naturalsmp.NaturalBounties.utils.BountyManager.claimBounty;
...
public class PVPRestrictions implements Listener {
    ...
    public void onPVP(EntityDamageByEntityEvent event) {
        if ((event.getEntity() instanceof Player entity && event.getDamager() instanceof Player damager) && !NaturalBounties.isPaused())

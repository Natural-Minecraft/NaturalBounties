...
public class MMOLibClass implements Listener {
    ...
    private static final String NaturalBounties_STAT_KEY = "NaturalBounties";
        ...
        if (ConfigOptions.getIntegrations().isMmoLibEnabled()) {
            for (Player player : Bukkit.getOnlinePlayers()) {
                ...
                for (StatInstance instance : statMap.getInstances()) {
                    instance.removeIf(NaturalBounties_STAT_KEY::equals);
                }
            }
        }
    }
    ...
    private static class BountyStatModifier {
        ...
        public BountyStatModifier(ConfigurationSection configuration) {
            ...
            try {
                ...
                Bukkit.getLogger().warning("[NaturalBounties] Invalid format for \"bounty\" in the MMOLib." + configuration.getName() + " configuration section!");
            ...
            if (stat == null) {
                stat = "UNKNOWN";
                Bukkit.getLogger().warning("[NaturalBounties] No stat string found in the MMOLib." + configuration.getName() + " configuration section!");
            }
            ...
            statModifier = new StatModifier(NaturalBounties_STAT_KEY, stat, configuration.getDouble("value"), modifierType);
        }

...
import me.naturalsmp.NaturalBounties.utils.tasks.RenderPoster;
...
public abstract class BountyPosterProvider {
    ...
    protected BountyPosterProvider(UUID uuid, Plugin plugin) {
        ...
        renderPoster.setTaskImplementation(NaturalBounties.getServerImplementation().global().runAtFixedRate(renderPoster, 1, 40));
    }

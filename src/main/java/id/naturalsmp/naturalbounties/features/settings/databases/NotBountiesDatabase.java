 ...
 */
public abstract class NaturalBountiesDatabase implements Comparable<NaturalBountiesDatabase>{
    ...
    protected NaturalBountiesDatabase(Plugin plugin, String name) {
        this.name = name;
        this.plugin = plugin;
    ...
    protected NaturalBountiesDatabase() {
        this.name = "Pseudo";
        this.plugin = null;
    ...
    protected synchronized boolean reconnect(Exception e) {
        ...
        Arrays.stream(e.getStackTrace()).forEach(stackTraceElement -> NaturalBounties.debugMessage(stackTraceElement.toString(), true));
            ...
            if (NaturalBounties.getInstance().isEnabled()) {
                if (!connect(false)) {
                    if (reconnectAttempts < 2)
                        NaturalBounties.getServerImplementation().async().runDelayed(() -> connect(true), 20L);
                    return false;
                }
                return true;
            }
    ...
    @Override
    public int compareTo(@NotNull NaturalBountiesDatabase o) {
    ...
    public boolean equals(Object o) {
        ...
        NaturalBountiesDatabase that = (NaturalBountiesDatabase) o;

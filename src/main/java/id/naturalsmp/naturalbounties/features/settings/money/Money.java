...
public class Money extends ResourceConfiguration {
    ...
    protected void loadConfiguration(YamlConfiguration config) {
        ...
        try {
            ...
            NaturalBounties.getInstance().getLogger().log(Level.WARNING, "Invalid default broadcast setting \"{0}\". Must be EXTENDED, SHORT, or DISABLE.", config.getString("default-broadcast-setting"));

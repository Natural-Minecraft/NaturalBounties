 ...
 */
public class ProxyDatabase extends NaturalBountiesDatabase {
    ...
    protected ConfigurationSection readConfig() {
        ...
        if (enabled && !registeredListener) {
            ...
            Plugin plugin = NaturalBounties.getInstance();
            plugin.getServer().getMessenger().registerOutgoingPluginChannel(plugin, "NaturalBounties:main");
            plugin.getServer().getMessenger().registerIncomingPluginChannel(plugin, "NaturalBounties:main", new ProxyMessaging());

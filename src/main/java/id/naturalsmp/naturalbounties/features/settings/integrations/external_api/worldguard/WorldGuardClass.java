package me.naturalsmp.NaturalBounties.features.settings.integrations.external_api.worldguard;
...
public class WorldGuardClass {
    ...
    public static void registerFlags() {
        ...
        if (Bukkit.getPluginManager().isPluginEnabled("WorldGuard")) {
            // NaturalBounties was loaded after WorldGuard was enabled. (WorldGuard flags cannot be registered)
            failedStartup = true;
            return;
        }
        registerClaimFlag();
    ...
    private static void registerBountyEntryFlag() {
        ...
        try {
            ...
            if (existing instanceof StateFlag stateFlag) {
                ...
                Bukkit.getLogger().warning("[NaturalBounties] Another plugin is using the same WorldGuard flag \"bounty-entry\", but with a different data type!");
                failedStartup = true;
            }
        }
    }
    ...
    private static void registerBountyExitFlag() {
        ...
        try {
            ...
            if (existing instanceof StateFlag stateFlag) {
                ...
                // types don't match - this is bad news! some other plugin conflicts with you
                // hopefully this never actually happens
                Bukkit.getLogger().warning("[NaturalBounties] Another plugin is using the same WorldGuard flag \"bounty-exit\", but with a different data type!");
                failedStartup = true;
            }
        }
    }
    ...
    private static void registerBountyTeleportExitFlag() {
        ...
        try {
            ...
            if (existing instanceof StateFlag stateFlag) {
                ...
                // types don't match - this is bad news! some other plugin conflicts with you
                // hopefully this never actually happens
                Bukkit.getLogger().warning("[NaturalBounties] Another plugin is using the same WorldGuard flag \"bounty-teleport-exit\", but with a different data type!");
                failedStartup = true;
            }
        }
    }
    ...
    private static void registerClaimFlag(){
        ...
        try {
            ...
            if (existing instanceof StateFlag) {
                ...
                // types don't match - this is bad news! some other plugin conflicts with you
                // hopefully this never actually happens
                Bukkit.getLogger().warning("[NaturalBounties] Another plugin is using the same WorldGuard flag \"claim-bounties\", but with a different data type!");
                failedStartup = true;
            }
        }
    }
    ...
    private static void registerPVPRuleFlag(){
        ...
        try {
            ...
            if (existing instanceof IntegerFlag) {
                ...
                // types don't match - this is bad news! some other plugin conflicts with you
                // hopefully this never actually happens
                Bukkit.getLogger().warning("[NaturalBounties] Another plugin is using the same WorldGuard flag \"bounty-pvp-rule\", but with a different data type!");
                failedStartup = true;
            }
        }
    }
    ...
    private static void registerCombatLogFlag(){
        ...
        try {
            ...
            if (existing instanceof IntegerFlag) {
                ...
                // types don't match - this is bad news! some other plugin conflicts with you
                // hopefully this never actually happens
                Bukkit.getLogger().warning("[NaturalBounties] Another plugin is using the same WorldGuard flag \"bounty-combat-log-time\", but with a different data type!");
                failedStartup = true;
            }
        }
    }

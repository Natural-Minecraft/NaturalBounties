...
import me.naturalsmp.NaturalBounties.features.settings.auto_bounties.CommandPrompt;
...
import static me.naturalsmp.NaturalBounties.features.LanguageOptions.getPrefix;
...
public class ActionCommands {
    ...
    public static void executeBountyJoin(Player player, Bounty bounty) {
        NaturalBounties.getServerImplementation().global().runDelayed(() -> {
    ...
    private static void execute(@Nullable Player player, @Nullable Player killer, @Nullable Bounty bounty, String command, UUID playerUUID) {
        ...
        NaturalBounties.debugMessage("Executing Command for " + playerName + " : " + command, false);
        ...
        NaturalBounties.debugMessage("Parsed Action: \"" + command + "\"", false);
    ...
    public static void runPlayerCommand(Player player, String command) {
        if (ServerVersions.isFolia()) {
            NaturalBounties.getServerImplementation().entity(player).run(() -> Bukkit.dispatchCommand(player, command));
        } else {
